        ...
        <div className="hidden md:block">
          <div className="ml-10 flex items-baseline space-x-4">
            ...
            {state.isAuthenticated ? (
              <>
                <span className="text-sm text-gray-100">Hello, {state.user.userName}</span>
                <button
                  onClick={handleLogout}
                  className="text-sm hover:bg-gray-700 px-3 py-2 rounded-md transition duration-300 text-gray-100"
                >
                  Logout
                </button>
              </>
    ...
    {isMenuOpen && (
      <div className="md:hidden">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {state.isAuthenticated ? (
            <>
              <span className="block px-3 py-2 text-base font-medium text-gray-100">Hello, {state.user.userName}</span>
              <button
                onClick={handleLogout}
